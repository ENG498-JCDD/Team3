...
export default {
  ...
  footer: `Created by Beatrice Ogeh, Alyssa Johnson, Sami Zito | <a href="https://jcddtc.netlify.app/" target="_blank" rel="noopenner noreferrer">ENG 583 - Justice-Centered Data Design</a>`, // what to show in the footer (HTML)
  // sidebar: true, // whether to show the sidebar
  // toc: true, // whether to show the table of contents
  // pager: true, // whether to show previous & next links in the footer
